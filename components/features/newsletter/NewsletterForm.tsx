  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Generate and download welcome PDF
        try {
          const resourceType = interests.includes('franchise') ? 'franchise_guide' : 
                             interests.includes('methodology') ? 'methodology_intro' : 
                             'general'
          ...
          await generateNewsletterWelcomePDF({
            ...
            autoDownload: true,
            filename: generateFilename('dobrodosli-vodic')
          })
        } catch (pdfError) {
          console.error('Error generating welcome PDF:', pdfError)
        }
